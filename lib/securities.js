...
Securities = (function() {
  ...
  Securities.prototype.應對 = function(jso, 回應) {
    var code, ref, ref1, results, symbol, tick;
    results = [];
    for (code in jso) {
      tick = jso[code];
      symbol = tick.代碼;
      ...
      if (this.清潔) {
        if (this.position.length > 0) {
          if (indexOf.call(this.position, symbol) < 0) {
            console.log(symbol, this.品種[symbol], (ref = this.品種[symbol]) != null ? ref.不可買 : void 0);
            if ((ref1 = this.品種[symbol]) != null ? ref1.不可買 : void 0) {
