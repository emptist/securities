...
Security = (function() {
  function Security(master, 代碼1, 策略, 池, 百分比) {
    var 代碼;
    this.代碼 = 代碼1;
    this.策略 = 策略;
          ...
          if (arr.length > 0) {
            ...
            updateM05 = function() {
              return hists({
                ...
                if ((err != null) || (arr == null)) {
                  return console.error("securities.coffee >>: " + 代碼 + " 更新5分鐘線", err);
...
Securities = (function() {
  function Securities(codes1, 策略, 池) {
    var code, i, len1, ref;
    this.codes = codes1;
    this.策略 = 策略;
    this.品種 = {};
    ...
    for (i = 0, len1 = ref.length; i < len1; i++) {
      code = ref[i];
      this.品種[code] = new Security(this, code, this.策略, 池, 0.618);
    }
  }

  Securities.prototype.重載 = function(code) {
    return this.品種[code] = new Security(this, code, this.策略, 池, 0.618);
  };
