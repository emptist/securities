    ...
    hists({
      ...
      return function(err, arr) {
        ...
        return hists({
          ...
          if (err != null) {
            return console.error("securities.coffee >> 81: " + _this.代碼, err);
          } else {
            if (arr == null) {
              ...
              排查發現個別品種下載數據會出錯
               */
              console.error("securities.coffee >> " + _this.代碼 + " 日線下載不到");
            }
            pool = new 池();
            _this.日線池 = pool.序列(arr);
            return console.log("securities.coffee >>" + _this.代碼 + ", 日線池.陰魚.尾.均: " + _this.日線池.陰魚.尾.均);
          }
        });
      };
    })(this));
