...
Security = (function() {
  ...
  Security.prototype.為分級A基金 = function() {
    return /^(1|5)/.test(this.代碼[0]) && /A|稳|先/.test(this.名稱);
  };

  Security.prototype.求止損比重 = function() {
    if (this.為分級A基金()) {
      return 0.618;
    } else {
      return 0.832;
    ...
    if (this.position != null) {
      ...
      *
      ...
      if (indexOf.call(this.position, symbol) < 0) {
        ...
        return console.log("securities >> " + this.symbols.length + ": " + this.symbols);
      }
    }
  };
